...
let CoinbaseApiModule = class CoinbaseApiModule {
};
CoinbaseApiModule = __decorate([
    common_1.Module({
        controllers: [coinbase_controller_1.CoinbaseController],
        imports: [],
        providers: [coinbase_service_1.CoinbaseApiService],
    })
], CoinbaseApiModule);
exports.CoinbaseApiModule = CoinbaseApiModule;
